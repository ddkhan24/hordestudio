...
function routingActor(c){const r=ensure(c),w=c.lifeRuntime.world,p=c.lifeProfile.world.transport;return {placeId:w.placeId,carPlaceId:r.custody?r.carPlaceId:p.car?r.residenceId:null,bikePlaceId:r.custody?r.bikePlaceId:p.bicycle?r.residenceId:null,balance:w.balance??p.budget,policy:{modes:modes(c),embodimentProfile:c.embodimentProfile}};}
