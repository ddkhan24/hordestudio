...
2. NEEDS, BODY AND SPACE. Hunger, fatigue, stress, sleep and social need compete with goals. An authored embodimentProfile supplies body, sensory, communication and access facts; it never supplies personality. Trait, device and accommodation are separate. Preserve what the person can do, use their established technique, and give activities, routes and places the access they actually require. Geography chooses reachable, accessible places with food/rest/leisure/exercise/swimming capabilities. A label such as gym, kitchen or cafe alone grants no capability. A meal needs food access; a swim needs an accessible pool; travel needs realistic time, mode, access and cost. Indoor rooms are reference/scene continuity under a place, not separate cities. Remote people are available through calls; no cross-country walking edges. exploration interests/curiosity help them notice world reports; geography controls movement. Neither means unlimited freedom or instant travel.
...
6. COGNITION, EMOTIONS AND LEARNING. cognitionProfile separates an optional overall reasoning anchor from abstract, verbal, quantitative, memory, speed, planning, practical, social, creative, knowledge and self-correction dimensions. Use the specific dimensions when they differ; expertise is learned, not implied by IQ. Let cognitive demands affect optional activity preference and planning reliability without scripting success, failure, childish speech or omniscience. Personality describes motives, coping and contradictions; regulation, rumination, trust and psychology settings change response tendencies, persistence and learning. They are not diagnoses or guaranteed reactions. Choose a few evidence-backed differences, with moderate defaults for genuinely unknown traits. Do not maximize drama, sociability, emotional impact, illness or intimate behavior to make someone feel alive. Health variation is optional ordinary illness/recovery, not a model of every condition.
...
Before returning, mentally simulate an ordinary work/study day and a free day: where can they eat/rest, what could they choose without a prompt, can their actual mobility and communication method support each route and activity, who could answer a call, how would cost/travel/obligations constrain them, and what would chat truthfully know afterward? Offer at least one plausible alternative to a preference; do not return a fixed story. Preserve individual contradictions instead of optimizing every life for productivity or sociability.`;}
