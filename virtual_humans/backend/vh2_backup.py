...
TABLES=('events','photo_jobs','photo_assets','transcript_messages','media_records','memory_episodes','kernel_checkpoints','dialogue_jobs','dialogue_receipts','vh2_provider_jobs','vh2_social_jobs','vh2_provider_outputs','vh2_story_jobs')
